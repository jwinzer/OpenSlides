...
.factory('MotionContentProvider', [
    ...
    'Motion',
    'VotingPrinciple',
    function($q, $filter, operator, gettextCatalog, PDFLayout, PdfMakeConverter, ImageConverter, HTMLValidizer, Category, Config, Motion, VotingPrinciple) {
        /**
        ...
        var createInstance = function(motion, motionVersion, changeRecommendationMode,
            ...
            var metaTable = function() {
                ...
                if (motion.polls.length > 0 && motion.polls[0].has_votes) {
                    var precision = VotingPrinciple.getPrecision(motion.category_id);
                    var column1 = [];
                    var column2 = [];
                    var column3 = [];
